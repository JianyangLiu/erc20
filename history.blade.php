            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link text-dark" id="v-pills-home-tab" data-toggle="pill" href="/Finance/balance" role="tab" aria-controls="v-pills-home" aria-selected="true">Balance</a>
                        <a class="nav-link active text-white" style="background-color:#192032" id="v-pills-profile-tab" data-toggle="pill" href="/Finance/history" role="tab" aria-controls="v-pills-profile" aria-selected="false">History</a>
                ...
                <div class="col">
                    <div class="row">
                        <a>
                            History：Default Show the last 30 days
                        </a>
                    </div>
                    ...
                    <div class=" row align-items-center">
                        ...
                        <div class="col ">
                            <button class="btn" style="float:right;border-radius:20px; width:140px;color: black;border: 2px solid #3f9ae5;">Search</button>
                        </div>
                    </div>
                    <div style="margin-top:40px"></div>
                    <div class="row">

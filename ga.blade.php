    ...
    <main class="pb-4">
        ...
        <div class="pt155 bg-img" style="background-color:royalblue; height:41px">
            <ul class="nav nav-tabs justify-content-center align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/user/moble">SETTINGS</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" style="background-color:#192032" id="v-pills-home-tab" data-toggle="pill" href="/user/moble" role="tab" aria-controls="v-pills-home" aria-selected="true">Authentication</a>
                        <a class="nav-link text-dark" id="v-pills-profile-tab" data-toggle="pill" href="/Finance/changepassword" role="tab" aria-controls="v-pills-profile" aria-selected="false">Change Password</a>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link text-dark"  href="/user/moble">MOBILE VERIFICATION</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/User/email">EMAIL VERIFICATION</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active text-primary" style="background-color: white" href="/User/ga">GOOGLE AUTHENTICATOR</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                            <div class="card-body" style="max-width: 80%">
                                <div class="col">
                                    <div class="col">
                                        <div class="text-dark">
                                            <div class="row">
                                                Scan this QR code with your Google Authenticator app on your mobile phone (download for iOS or Android). Once scanned you will be presented with a random 6 digit number. Enter that number below to finish the setup process.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col" style="margin-top:20px">
                                        ...
                                        <div class="row align-items-center" style="margin-top:30px">
                                            <div>
                                                <button class="btn" style="float:right;border-radius:20px; width:140px;color: black;border: 2px solid #3f9ae5;">activate</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

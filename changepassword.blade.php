                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link active text-primary" style="background-color: white" href="/Finance/changepassword">LOG IN PASSWORD</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/Finance/paypassword">TRADING PASSWORD</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/Finance/findpaypwd">RETRIEVE TRADING PASSWORD</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">

                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs justify-content-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active text-primary" style="background-color: white" href="/User/email">EMAIL VERIFICATION</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/User/ga">GOOGLE AUTHENTICATOR</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">

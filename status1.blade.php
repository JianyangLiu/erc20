    ...
    <main class="pb-4">
        ...
        <center>
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                ...
                <a  href="/Finance/project/status/1" class="btn text-white active" style="background-color:royalblue;border-radius:20px; width:140px;" >
                    Complete
                </a>
                <a class="btn text-dark" style="background-color: white;border-radius:20px; width:140px;" href="/Finance/project/status/2">

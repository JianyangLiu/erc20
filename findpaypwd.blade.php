            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link text-dark"  id="v-pills-home-tab" data-toggle="pill" href="/user/moble" role="tab" aria-controls="v-pills-home" aria-selected="true">Authentication</a>
                        <a class="nav-link active" style="background-color:#192032" id="v-pills-profile-tab" data-toggle="pill" href="/Finance/changepassword" role="tab" aria-controls="v-pills-profile" aria-selected="false">Change Password</a>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/Finance/changepassword">LOG IN PASSWORD</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="/Finance/paypassword">TRADING PASSWORD</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active text-primary" style="background-color: white" href="/Finance/findpaypwd">RETRIEVE TRADING PASSWORD</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col" style="margin-top:15px">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div style="margin-left:60px;">
                                            <button type="button" class="btn-primary" style="border-radius:20px;width:100px;height:40px">
                                                Send
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                                        <div>
                                            <button class="btn" style="float:right;border-radius:20px; width:140px;color: black;border: 2px solid #3f9ae5;">Save</button>
